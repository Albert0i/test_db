...
### I. Introduction
If you opt to use [NodeJS](https://nodejs.org/en) related technique and [Relational database](https://www.oracle.com/in/database/what-is-a-relational-database/), [prisma](https://www.prisma.io/) seems an obvious choice, if it were not the only choice... 
...
Having finished [Primsa x Planetscale ── A starter guide](https://github.com/Albert0i/prisma-planetscale/blob/main/README.md) and [The Myth and Riddle of ORM](https://github.com/Albert0i/prisma-planetscale/blob/main/ORM.md) and voiced out my opinions, my journey of ORM stops here... for now... at least... 
